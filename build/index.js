...
const sockets = __importStar(require("./socket/server"));
...
const init = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const container = (0, container_1.buildContainer)(adaptedSocket);
    // Attach event listeners to socket
    sockets.attachListeners(adaptedSocket.io, container);
    // Start listening on socket
    adaptedSocket.io.listen(server_1.default.httpServer);
